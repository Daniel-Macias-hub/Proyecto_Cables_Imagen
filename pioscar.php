...
function envia(enviar)

{
	 
cadena = enviar;
window.open(cadena,'','height=850,width=850,titlebar=NO,scrollbars=NO',);
...
<a class=n target=select href=xhdl.php>XHDL </a><br><br><br>

</tr>
<tr><td bgcolor=#fb7922 colspan=1 background="img/strichel.gif" class=white><img src=img/blank.gif width=1 height=1></td></tr>
<tr valign=top><td align=right class=navi>
<a class=n target=select href=XEDA.php>XEDA </a><br><br><br>    

</tr>
<tr><td bgcolor=#fb7922 colspan=1 background="img/strichel.gif" class=white><img src=img/blank.gif width=1 height=1></td></tr>
<tr valign=top><td align=right class=navi>
<a class=n target=text onclick="envia('PopNuevo.php');"> <b>Nuevo</b><img src="img/documenting.png" width="25" height="25" alt="Los Tejos" /></a><br><br><br>    
