...
<meta http-equiv="Refresh" content="60,rtreco.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"RTR\" AND ( cat=\"OEC\" OR cat=\"f\") ORDER BY fecha DESC,hora DESC;");
$i=0;
