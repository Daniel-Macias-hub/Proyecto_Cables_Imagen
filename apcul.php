...
<meta http-equiv="Refresh" content="60,apcul.php">
</head>
<body>
...
$result=mysql_query("SELECT titulo,age,fecha,hora,path FROM cables WHERE age=\"AP\" AND cat=\"r c\" ORDER BY fecha DESC ,hora DESC;"); 
$i=0;
