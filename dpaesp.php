...
<meta http-equiv="Refresh" content="90,dpades.php">
</head>
<body>
...
$result=mysql_query("SELECT titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"r e\" AND age=\"DPA\" ORDER BY fecha DESC,hora DESC;");    
       $i=0;
