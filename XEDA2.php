...
<td class=tabhead><img src=img/blank.gif width=80 height=8><br><b>Menciones Programadas En XEDA</b></td>
<td><img src=img/blank.gif width=10 height=25></td>
</tr>
...
"<BR><font color=\"green\"> Titulo Cliente: </font>".$row['Nombre'].
...
"<BR><font color=\"DarkBlue\"> Observacion    </font> ".$row['obs']." </b></td>";
 ...
 echo "<a class=n target=text href=".$row['rutamp3']."><img src=".$iclip." width=40 height=20> <br>"; 
