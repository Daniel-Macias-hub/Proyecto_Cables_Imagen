...
//ho "<a class=n target=text href=".$ruta."><img src=".$iclip." width=40 height=20> <br>"; 
	$today = date("Y-m-d");
	$cadena="programstest.php?dateT=".$today.'&station=10000000001';
?>
<html>
<!DOCTYPE html>
<head>
...
<body leftmargin=0 topmargin=10 class=navi>
	<table border=0 cellpadding=0 cellspacing=2>
		...
		<tr valign=top>
			<td align=right class=navi>
				<a class=n target=select href=xhdltest.php><img src=img/calendr.png width=25 height=15>
				<a class=n target=select href=xhdltest.php>.  XHDL </a>	
		...
		<tr valign=top>
			<td align=right class=navi>
				<a class=n  target=select href=xhdltest.php><img src=img/calendar-icon.png width=45 height=45>
