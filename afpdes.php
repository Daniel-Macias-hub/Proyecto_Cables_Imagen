...
<td class=tabhead><img src=img/blank.gif width=150 height=8><br><b>ver</b></td>
<td><img src=img/blank.gif width=10 height=25></td>
</tr>


<?
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"AFP\" ORDER BY fecha DESC,hora DESC;");
