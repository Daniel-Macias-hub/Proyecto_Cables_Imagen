...
<meta http-equiv="Refresh" content="60,afpeco.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"04\" AND age=\"AFP\" ORDER BY fecha DESC,hora DESC;");    
   $i=0;
