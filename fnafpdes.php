...
$result=mysql_query("SELECT id,st,age,cat,tit,aut,fec,path,capt2 FROM fotos WHERE age=\"AFP\" ORDER BY fec DESC LIMIT 2000 ;"); 
    $i=0;
    $mm="";
...
if(strpos($mm,".pdf") !== false )
{
  $mm = str_replace(".pdf",".jpg",$mm);
