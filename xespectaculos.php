...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"01\"  OR  cat=\"NTX-W-\" OR cat=\"R E\" OR  cat=\"r e\" OR  cat=\"m\" ORDER BY fecha DESC ,hora DESC;");  
$i=0;
