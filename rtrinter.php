...
<meta http-equiv="Refresh" content="60,rtrinter.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE (cat=\"i  \" OR cat=\"a  \" ) AND age=\"RTR\" ORDER BY fecha DESC,hora DESC;");
$i=0;
