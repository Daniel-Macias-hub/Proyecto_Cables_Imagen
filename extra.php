...
$result=mysql_query("SELECT id,st,cat,tit,aut,fec,audios.key,path FROM audios WHERE cat<>\"CD\" AND cat<>\"DC\" AND cat<>\"PF\" AND cat<>\"GO\" AND cat<>\"ME\" AND cat<>\"JA\" AND cat<>\"JF\" AND cat<>\"AM\" ORDER BY fec DESC;");
$i=0;
