...
<meta http-equiv="Refresh" content="60,fninter.php">
</head>
<body>
...
$result=mysql_query("SELECT cat,tit,aut,fec,path FROM fotos WHERE age=\"NOTIMEX\" AND cat=\"  INT\" ORDER BY fec;"); 
    $i=0;
	...
	echo "<td class=tabval><a class=n target=text href=text.php?action=ft&id=".$row['path']."><span class = red >[ver]</span></td>";
