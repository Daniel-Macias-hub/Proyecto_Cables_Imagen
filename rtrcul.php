...
<meta http-equiv="Refresh" content="60,rtrcul.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"4 s\" AND age=\"AFP\" ORDER BY fecha DESC,hora DESC;");
