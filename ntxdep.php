...
<meta http-equiv="Refresh" content="60,ntxdep.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"NTX-S-\" AND age=\"NTX\" ORDER BY fecha DESC,hora DESC;");    
$i=0;
