...
window.status="Proximo Refresh : "+reloadseconds+ " segundos"
}
}
else {
clearTimeout(timer)
...
$result=mysql_query("SELECT titulo,age,fecha,hora,path FROM cables WHERE age=\"AP\" ORDER BY fecha DESC,hora DESC;");    
$i=0;
