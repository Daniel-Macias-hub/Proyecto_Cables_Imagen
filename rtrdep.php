...
<meta http-equiv="Refresh" content="60,rtrdep.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"RTR\" AND ( cat=\"SPO\" OR cat=\"s\") ORDER BY fecha DESC,hora DESC;");    
$i=0;
