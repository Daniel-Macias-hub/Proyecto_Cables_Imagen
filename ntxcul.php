...
<meta http-equiv="Refresh" content="60,ntxcul.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"NTX-S-\" AND age=\"AFP\" ORDER BY fecha DESC,hora DESC;");   
    $i=0;
