		...
		while( $row=mysql_fetch_array($result) )	
			{
					...
					$clipCompleto = "<a class=n target=text href=".$ruta."><img src=".$iclip." width=40 height=20> <br>";
					
					
					if ($row['rutamp3'] == '') 
					{
						$iclip= "img/noclipcito.png";
						$clipCompleto = "<a class=n target=text href=ErasePi.php?PI=".$row['id']."><img src='img/DelBut.png' width=60 height=50> <br>";
					...
					echo "<td class=tabval>
						  <a class=n target=text href=text2.php?action=pi&id=".$row['id']."&nom=".$row['idTR']."><img src=img/tikachico.png width=50 height=50> <br>";
					echo $clipCompleto; 
