...
<td class=tabhead><img src=img/blank.gif width=80 height=8><br><b>Inews Corresponsales </b></td>
<td><img src=img/blank.gif width=10 height=25></td>
</tr>
<?
...
$result=mysql_query("SELECT id,num,cola,tit,rep,cam,form,foto,vid,link,estat,edo,ftp,age,idAvid,adela,aprov,modi,fmod,creby,credate,fechact FROM mesaint WHERE cola=\"MESA-INFORMACION.ORDENDELDIA.CORRESPONSALES\" ORDER BY id ASC ;");
