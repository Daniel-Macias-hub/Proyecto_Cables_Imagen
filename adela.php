...
<meta http-equiv="Refresh" content="60,adela.php">
</head>
<body>
...
$result=mysql_query("SELECT id,st,cat,tit,aut,fec,audios.key,path FROM audios WHERE cat=\"AM\" ORDER BY fec DESC;");
$i=0;
