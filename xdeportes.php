...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"15\" OR cat=\"NTX-S-\" OR cat=\"NTX-S-\" OR cat=\"r s\" OR (cat=\"SPO\" OR cat=\"s\") ORDER BY fecha DESC ,hora DESC;");
   $i=0;
