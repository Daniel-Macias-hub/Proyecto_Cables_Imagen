...
<meta http-equiv="Refresh" content="60,i3a.php">
</head>
<body>
...
<td class=tabhead><img src=img/blank.gif width=60 height=16><br><b>Titulo </b></td>
<td class=tabhead><img src=img/blank.gif width=40 height=16><br><b>fecha</b></td>
<td class=tabhead><img src=img/blank.gif width=5 height=16><br><b>ver</b></td>
<td><img src=img/blank.gif width=10 height=25></td>
</tr>
...
$result=mysql_query("SELECT id,st,cat,tit,fec,path FROM tnews WHERE cat=\"Al Aire3a\" ORDER BY ord ASC;");
//$result=mysql_query("SELECT id,st,cat,tit,fec,path,ord FROM tnews WHERE cat=\"ordenx\" ORDER BY ord ASC;");
$i=0;
