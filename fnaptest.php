...
$result=mysql_query("SELECT id,age,cat,tit,aut,fec,path,capt2 FROM fotos WHERE age=\"AP\" and cat=\"SPF\" ORDER BY fec DESC;"); 
    $i=0;
    $mm="";
	...
	$mm = str_replace("/fotoap","/fotoap/tumb",$row['path']);
        echo "<td class=tabval><img src=img/blank.gif width=1 height=2></td>";
	echo "<td class=tabval><b>".$row['tit']."</b></td>";
        echo "<td class=tabval><a class=n target=text href=text.php?action=ft&id=".$row['id']."><img src=$mm> <br>";
