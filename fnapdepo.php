...
$result=mysql_query("SELECT id,st,age,cat,tit,aut,fec,path,capt2 FROM fotos WHERE age=\"AP\" and ( capt2=\"S\" or capt2=\"SPANS\" or capt2=\"HKN\" or capt2=\"MOT\" or capt2=\"FBN\" or capt2=\"GLF\" or capt2=\"SOC\" or capt2=\"BKN\" or capt2=\"NBA\" or capt2=\"BBA\") ORDER BY fec DESC;"); 
    $i=0;
    $mm="";
