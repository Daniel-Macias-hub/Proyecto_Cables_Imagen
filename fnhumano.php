...
$result=mysql_query("SELECT id,age,cat,tit,aut,fec,path,capt2 FROM fotos WHERE age=\"NOTIMEX\" and ( capt2=\"HUM\" or capt2=\"HTH\" or capt2=\"REL\" or capt2=\"LIF\" ) ORDER BY fec DESC;"); 
    $i=0;
    $mm="";
