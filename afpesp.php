...
<meta http-equiv="Refresh" content="60,afpesp.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"01\" AND age=\"AFP\" ORDER BY fecha DESC ,hora DESC;");  
$i=0;
