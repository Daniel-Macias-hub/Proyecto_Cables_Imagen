...
$result=mysql_query("SELECT id,num,cola,tit,rep,cam,form,foto,vid,link,estat,edo,ftp,age,idAvid,adela,aprov,modi,fmod,creby,credate,fechact FROM mesaint WHERE cola=\"MESA-INFORMACION.ORDENDELDIA.ENTREVISTAS\" ORDER BY id ASC ;");
$i=0;
