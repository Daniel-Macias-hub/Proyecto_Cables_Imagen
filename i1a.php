...
<meta http-equiv="Refresh" content="90,i1a.php">
</head>
<body>
...
$result=mysql_query("SELECT id,st,cat,tit,fec,path,ord FROM tnews WHERE cat=\"NotasAire\" ORDER BY ord ASC;");
...
while( $row=mysql_fetch_array($result) )
	...
	echo "</tr>";
        ...
        $httpm="http://10.29.128.184";
        $httpm.= $haystack;
  echo "<td class=tabval><a class=n target=text href= $httpm><img src=img/tico2.JPG width=25 height=35></td>";
  }
        else {
