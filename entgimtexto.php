...
<meta http-equiv="Refresh" content="90,entgimtexto.php">
</head>
<body>
...
$result=mysql_query("SELECT id,st,cat,tit,fec,path FROM tnews WHERE cat=\"ENTGIMTEXTO\" ORDER BY fec DESC;");
...
while( $row=mysql_fetch_array($result) )
	...
	echo "</tr>";
        ...
        $httpm.= $haystack;
  echo "<td class=tabval><a class=n target=text href= $httpm><span class = red >[ver]</span></td>";
  }
        else {
