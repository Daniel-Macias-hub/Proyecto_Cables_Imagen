...
<meta http-equiv="Refresh" content="60,ja.php">
</head>
<body>
...
$result=mysql_query("SELECT id,st,cat,tit,aut,fec,key,path FROM audios WHERE key = \"90.5\" ORDER BY fec DESC LIMIT 1000;");
$i=0;
