...
<meta http-equiv="Refresh" content="60,ntxesp.php">
</head>
<body>
...
<td style="width: 2px; background-color: White; margin: 1px;"><img src=img/blank.gif width=5 height=8><br><b></b></td>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"NTX\" AND ( cat=\"NTX-W-\" OR cat=\"NTX-E-\" OR cat=\"R E\" ) ORDER BY fecha DESC,hora DESC;");    
$i=0;
