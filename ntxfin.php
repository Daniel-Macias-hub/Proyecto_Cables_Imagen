...
<meta http-equiv="Refresh" content="60,ntxfin.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"NTX\" AND cat=\"NTX-F-\" ORDER BY fecha DESC,hora DESC;");    
$i=0;
