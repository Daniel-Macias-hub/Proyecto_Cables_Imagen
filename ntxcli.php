...
<meta http-equiv="Refresh" content="60,ntxcli.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"NTX-O-\" AND age=\"NTX\" ORDER BY fecha DESC,hora DESC;");    
$i=0;
