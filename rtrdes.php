...
<body>
<input type="checkbox" id="chk" onclick="enableDisableRefresh(this.checked)" /><label for="chk">Deshabilitar-AutoRefresh</label>
...
<tr bgcolor=#f87820>
<td><img src=img/blank.gif width=1 height=25></td>

<td class=tabhead><img src=img/blank.gif width=300 height=8><br><b>Titulo </b></td>
<td style="width: 2px; background-color: White; margin: 1px;"><img src=img/blank.gif width=4 height=8><br><b></b></td>
<td class=tabhead><img src=img/blank.gif width=300 height=8><br><b>fecha</b></td>
<td class=tabhead><img src=img/blank.gif width=4 height=8><br><b>ver</b></td>
<td><img src=img/blank.gif width=2 height=35></td>
</tr>
...
//$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"AFP\" ORDER BY fecha DESC;");

if(!session_id()) session_start();
$server = $_SESSION['server'];

$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"RTR\" ORDER BY fecha DESC,hora DESC;");
$i=0;
