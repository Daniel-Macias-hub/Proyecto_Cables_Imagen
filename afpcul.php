...
<meta http-equiv="Refresh" content="60,afpcul.php">
</head>
<body>
...
$result=mysql_query("SELECT titulo,age,cat,fecha,hora,path FROM cables WHERE cat=\"10\" OR cat=\"08\" OR cat =\"05\" AND age=\"AFP\" ORDER BY fecha DESC,hora DESC ;");
    $i=0;
