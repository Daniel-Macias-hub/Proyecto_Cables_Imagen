...
$result=mysql_query("SELECT cat,tit,aut,fec,path FROM fotos WHERE age=\"NOTIMEX\" AND cat=\"  ACE\" OR cat=\"  HUM\" ORDER BY fec DESC;");
    $i=0;
    $mm="";
	...
	echo "<td class=tabval><b>".$row['tit']."</b></td>";
        echo "<td class=tabval><a class=n target=text href=text.php?action=ft&id=".$row['path']."><img src=$mm> <br>";
