...
<meta http-equiv="Refresh" content="60,ntxnac.php">
</head>
<body>
...
$result=mysql_query("SELECT id,titulo,age,cat,fecha,hora,path FROM cables WHERE age=\"NTX\" AND  (cat=\"NTX-I-\" OR cat=\"R V\") ORDER BY fecha DESC,hora DESC;");
$i=0;
